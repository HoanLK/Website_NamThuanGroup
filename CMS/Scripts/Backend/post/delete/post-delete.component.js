import templateUrl from "./post-delete.component.html";

export default class PostDeleteController {
  constructor($timeout, DevextremeService, PostService) {
    "ngInject";
      ...
      btnYes: {
        ...
        onClick: (e) => {
          if (!angular.isUndefined(this.id)) {
            ...
            this.postService.delete(this.id).then(
              (res) => {
                // Refresh Grid
                this.onDeleted();
...
PostDeleteController.$inject = ["$timeout", "DevextremeService", "PostService"];

export const PostDeleteComponent = {
