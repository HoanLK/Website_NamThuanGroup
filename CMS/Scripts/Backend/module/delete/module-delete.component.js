import templateUrl from "./module-delete.component.html";

export default class ModuleDeleteController {
  constructor($timeout, DevextremeService, ModuleService) {
    "ngInject";
      ...
      btnYes: {
        ...
        onClick: (e) => {
          if (!angular.isUndefined(this.id)) {
            ...
            this.moduleService.delete(this.id).then(
              (res) => {
                // Refresh Grid
                this.onDeleted();
            ...
            // Message
            toastr.error(`Vui lòng chọn module cần xóa`);
...
ModuleDeleteController.$inject = [
  "$timeout",
  "DevextremeService",
  "ModuleService",
];

export const ModuleDeleteComponent = {
