(function (app) {
    ...
    app.factory('CategoryPostService', CategoryPostService);

    CategoryPostService.$inject = ['$http', '$window', 'ArrayService', 'DateTimeService', 'DevExtremeService', 'StringService'];

    function CategoryPostService($http, $window, ArrayService, DateTimeService, DevExtremeService, StringService) {
        var services = {};
