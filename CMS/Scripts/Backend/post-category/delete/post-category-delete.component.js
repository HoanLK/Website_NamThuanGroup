import templateUrl from "./post-category-delete.component.html";

export default class PostCategoryDeleteController {
  constructor($timeout, DevextremeService, PostCategoryService) {
    "ngInject";
      ...
      btnYes: {
        ...
        onClick: (e) => {
          if (!angular.isUndefined(this.id)) {
            ...
            this.postCategoryService.delete(this.id).then(
              (res) => {
                // Refresh Grid
                this.onDeleted();
...
PostCategoryDeleteController.$inject = [
  "$timeout",
  "DevextremeService",
  "PostCategoryService",
];

export const PostCategoryDeleteComponent = {
  template: templateUrl,
  controller: PostCategoryDeleteController,
  bindings: {
    visible: "<",
    id: "<",
    onDeleted: "&",
